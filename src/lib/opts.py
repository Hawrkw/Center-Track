...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--dataset', default='mot',
                             help='coco | kitti | coco_hp | pascal | mot')
    ...
    self.parser.add_argument('--demo', default='/home/ivo/PycharmProjects/CenterNet-Track/images/18124840932_e42b3e377c_k.jpg',
                             help='path to image/ image folders/ video. '
                                  'or "webcam"')
    self.parser.add_argument('--load_model', default='/home/ivo/PycharmProjects/CenterNet-Track/models/ctdet_coco_dla_2x.pth',
  ...
  def parse(self, args=''):
    ...
    opt.root_dir = '/home/ivo/PycharmProjects/CenterNet-Track'
  ...
  def init(self, args=''):
    ...
    default_dataset_info = {
      'ctdet': {'default_resolution': [512, 512], 'num_classes': 1,
                'mean': [0.469606, 0.463461, 0.441153], 'std': [0.227705, 0.231759, 0.227425],
                'dataset': 'mot'},
